...
impl Channel {
    ...
    /// (`Dev`, `Local`, `Integration`) and OSS builds honor them for local development and testing.
...
mod tests {
    ...
    #[test]
    fn oss_allows_server_url_overrides() {
        assert!(Channel::Oss.allows_server_url_overrides());
    }

    #[test]
    fn stable_release_channels_do_not_allow_server_url_overrides() {
